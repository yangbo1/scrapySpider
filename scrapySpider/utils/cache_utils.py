...
class Cache(object):
    ...
    def __init__(self):
        self.__redis = redis.Redis(connection_pool=self.__pool, encoding='utf-8')
    ...
    def hset(self, name, key, value):
        ...
        :return:
        """
        return self.__redis.hset(name=name, key=key, value=value)
